...
bool project::SdlInput::IsKeyDown(EKey keycode)
{
...
bool project::SdlInput::IsButtonDown(int button)
{
    return m_MouseStates[button];
}

void project::SdlInput::GetMousePosition(int* x, int* y)
{
    *x = m_MouseX;
    *y = m_MouseY;
}